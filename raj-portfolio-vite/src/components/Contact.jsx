...
/* ── standard icons (inline to avoid import issues) ── */
const LinkedInIcon = () => (
...
function SocialCard({ item, index }) {
  ...
  const handleMove = (e) => {
    ...
    cardRef.current.style.transform = `perspective(800px) rotateX(${y * -15}deg) rotateY(${x * 15}deg) translateZ(10px)`;
  }
  ...
  return (
    <section id="contact" className={styles.contact}>
      ...
      <div className={styles.bgScene}>
        <div className={styles.grid3d} style={{ '--mx': `${mouse.x}%`, '--my': `${mouse.y}%` }} />
      ...
      <div ref={headRef1} className="reveal">
        ...
        <p className={styles.subText}>
          Open to internships, collaborations, and exciting opportunities.<br />
          Let's build something great together.
        </p>

        <div className={styles.emailSection}>
          <a href={`mailto:${personalInfo.email}`} className={styles.largeEmail}>
            {personalInfo.email}
          </a>
