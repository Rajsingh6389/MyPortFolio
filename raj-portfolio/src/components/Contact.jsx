  ...
  return (
    <section id="contact" className={styles.contact}>
      ...
      <div ref={ref1} className="reveal">
        ...
        <h2 className={styles.title}>Let's <em>Connect</em></h2>
      ...
      <div ref={ref2} className={`${styles.links} reveal d2`}>
        <a href={personalInfo.linkedin} target="_blank" rel="noreferrer" className={styles.link}>
          <LinkedInIcon /> LinkedIn
        </a>
        <a href={personalInfo.github} target="_blank" rel="noreferrer" className={styles.link}>
          <GithubIcon /> GitHub
        </a>
        <a href={personalInfo.portfolio} target="_blank" rel="noreferrer" className={styles.link}>
          <GlobeIcon /> Portfolio
        </a>
